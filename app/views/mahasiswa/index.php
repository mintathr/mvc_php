			...
			<h3>Daftar Mahasiswa</h3>
				...
				<?php foreach($data['mhs'] as $mhs) : ?>
					<li class="list-group-item"><?= $mhs['nama']; ?>
				  		<a href="<?= BASEURL; ?>/mahasiswa/hapus/<?= $mhs['id'];?>" class="badge badge-danger float-right ml-1" onclick="return confirm('yakin dihapus?')">Hapus</a>
				  		<a href="<?= BASEURL; ?>/mahasiswa/ubah/<?= $mhs['id'];?>" class="badge badge-info float-right ml-1 tampilModalUbah" data-toggle="modal" data-target="#formModal" data-id="<?= $mhs['id']; ?>">ubah</a>
